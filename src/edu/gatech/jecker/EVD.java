...
public class EVD {
     ...
     */
    private void tridiagonalizeWithQL() {
    ...
    private void complexDivision(double xr, double xi, double yr, double yi) {
        double r, d;
        ...
        for (n = nn - 1; n >= 0; n--) {
            ...
            if (q == 0) {
                ...
                if (Math.abs(H[n][n - 1]) > Math.abs(H[n - 1][n])) {
                    ...
                    complexDivision(0.0, -H[n - 1][n], H[n - 1][n - 1] - p, q);
                    H[n - 1][n - 1] = cdivr;
                    H[n - 1][n] = cdivi;
                }
                H[n][n - 1] = 0.0;
